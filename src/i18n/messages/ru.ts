...
export const ru: SiteMessages = {
  ...
  features: {
    ...
    items: [
      ...
      },
      {
        ...
        text: 'Интерфейс доступен на узбекском (латиница и кириллица), английском и русском. Язык задаётся для каждого редактора или сразу для всего приложения.'
      },
      {
  ...
  playground: {
    eyebrow: 'Песочница',
    title: 'Попробуйте пропсы и скопируйте код.',
    lead: 'Каждое изменение на панели сразу применяется к редактору, а код ниже всегда соответствует тому, что вы видите.',
    editor: 'Редактор',
    controls: 'Пропсы',
    viewMode: 'Режим при открытии',
    viewPage: 'Страница',
    viewWeb: 'Веб',
    ...
    maxLength: 'Лимит символов, 0 — без ограничений',
    ...
    trackChangesOn: 'Записывать исправления',
